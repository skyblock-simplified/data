 ...
 * <p>Package layout:
 * <ul>
 *   <li>{@link dev.sbs.data.poller.AssetPoller} - Spring {@code @Component} with
 ...
 *       end.</li>
 *   <li>{@link dev.sbs.data.poller.AssetDiffEngine} - pure-function delta engine
 *       comparing a manifest snapshot against persisted per-entry state rows.</li>
 *   <li>{@link dev.sbs.data.poller.AssetDiff} - immutable result type with three
 *       lists (added, changed, removed) and an {@code empty} sentinel.</li>
 *   <li>{@link dev.sbs.data.poller.LastResponseAccessor} - functional interface
