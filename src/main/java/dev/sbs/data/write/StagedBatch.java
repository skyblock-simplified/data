 ...
 * {@link dev.sbs.data.persistence.WritableRemoteJsonSource#stageBatch(ConcurrentMap)}
 ...
 * caller reads these fields. The {@link dev.sbs.data.write.WriteBatchScheduler}
...
public final class StagedBatch<T extends JpaModel> {
     ...
     * {@link dev.sbs.data.persistence.WritableRemoteJsonSource#stageBatch()}
     ...
     * {@code dev.sbs.data.persistence} package.
     */
    public StagedBatch(
