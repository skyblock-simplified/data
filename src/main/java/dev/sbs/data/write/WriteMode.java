...
public enum WriteMode {
    ...
    /**
     * Multi-file single-commit via the {@link api.simplified.skyblock.contract.SkyBlockGitDataContract
     ...
     * {@link dev.sbs.data.poller.AssetPoller} would otherwise observe between two
     * Contents-mode commits in the same tick.
     */
    GIT_DATA,

    /**
     * Per-file commits via the {@link api.simplified.skyblock.contract.SkyBlockDataContract
     * Contents API}. Every dirty {@link dev.sbs.data.persistence.WritableRemoteJsonSource}
