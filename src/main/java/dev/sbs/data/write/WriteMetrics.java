 ...
 * {@code data} write path. Registered as a Spring {@code @Component}
 ...
 * (the {@link dev.sbs.data.persistence.WritableRemoteJsonSource}
...
public class WriteMetrics {
     ...
     * {@link dev.sbs.data.persistence.WritableRemoteJsonSource}
